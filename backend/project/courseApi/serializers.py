...
class FeedbackSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Feedback
        fields = ['fid', 'course_code', 'student_roll_no', 'rating', 'title', 'description']
    
    def get_student_roll_no(self, obj): # retrieving the roll no of the student instead of the student id.
